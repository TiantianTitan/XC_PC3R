...
#define PanSource	"./tme4_parite1.pml"
...
#define _nstates3	7	/* Collecteur */
#define minseq3	49
#define maxseq3	54
#define _endstate3	6

#define _nstates2	12	/* Ouvrier */
#define minseq2	38
#define maxseq2	48
#define _endstate2	11

#define _nstates1	26	/* Gestionnaire */
#define minseq1	13
#define maxseq1	37
#define _endstate1	25

#define _nstates0	14	/* Producteur */
#define minseq0	0
#define maxseq0	12
...
#define Air3	(sizeof(P3) - Offsetof(P3, id) - 1*sizeof(int))

#define POuvrier	((P2 *)_this)
typedef struct P2 { /* Ouvrier */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, id) - 1*sizeof(int))

#define PGestionnaire	((P1 *)_this)
typedef struct P1 { /* Gestionnaire */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define PProducteur	((P0 *)_this)
typedef struct P0 { /* Producteur */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
